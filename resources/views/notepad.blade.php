                ...
                <section class="p-6">
                    ...
                    <script>
                        ...
                        function setNotepad(noteList, currentPage) {
                            ...
                            while (currentNote < lastNote) {
                                if (currentNote < noteList.length) {
                                    ...
                                    output += '<div data-id="' + noteId + '" onclick="showNote(' + noteId + ');" class="note"><p>' + noteTitle + '</p><p>' + noteBody + '</p>' + '<span>' + noteDate + '</span></div>';
                                }

                                currentNote++;
                            }

                            notepad.innerHTML = output;
                        ...
                        function setPagination(noteList, currentPage) {
                            ...
                            output += '<button id="first" data-page="' + (firstPage) + '" onclick="goToPage(this);"></button>';
                            output += '<button id="previous" data-page="' + (currentPage - 1) + '" onclick="goToPage(this);"></button>';

                            // Print the first three pages
                            for (let i = firstPage; i <= (firstPage + 2); i++) {

                                // Break the loop if the current page is the penultimate
                            ...
                            if (currentPage <= firstPage + 2 || currentPage > totalPages - 2) {
